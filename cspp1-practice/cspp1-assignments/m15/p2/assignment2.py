...
class Message():
    ...
    def build_shift_dictnry(self, shift):
        ...
        self.shift_dictnry = dict(zip(full_keys, full_values))
        return self.shift_dictnry
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i not in self.build_shift_dictnry(shift).keys():
                new_msg.append(i)
                continue
            else:
                new_msg.append(self.build_shift_dictnry(shift)[i])
        return ''.join(new_msg)
...
class PlaintextMessage(Message):
    ...
    def __init__(self, text, shift):
        ...
        self.encrypting_dict = message.build_shift_dictnry(shift)
