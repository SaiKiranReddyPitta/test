...
class Message():
    ...
    ### DO NOT MODIFY THIS METHOD ###
    def build_shift_dictry(self, shift):
        '''
        ...
        self.shift_dictry = dict(zip(full_keys, full_values))
        return self.shift_dictry
    ...
    def apply_shift(self, shift):
        ...
        for i in self.message_text:
            if i not in self.build_shift_dictry(shift).keys():
                new_msg.append(i)
                continue
            else:
                new_msg.append(self.build_shift_dictry(shift)[i])
        return ''.join(new_msg)
...
class PlaintextMessage(Message):
    ...
    def __init__(self, text, shift):
        ...
        self.encrypting_dict = message.build_shift_dictry(shift)
